...
if (!nodeSupported) {
  throw new Error(
    `DSH 0.1.2-alpha.5 requires Node ^22.19.0 or >=24.0.0; received ${process.versions.node}`,
  )
}

const pnpmVersion = execFileSync('pnpm', ['--version'], { encoding: 'utf8' }).trim()
if (pnpmVersion !== '11.7.0') {
  throw new Error(`DSH 0.1.2-alpha.5 clean-Profile baseline requires pnpm 11.7.0; received ${pnpmVersion}`)
}
