...
- the reserved feedback row stays 22px / 12px type: idle shows the local-only 梁号 (`小梁号：勤香 • 死夯梁`); a dump shows `已上香 · 夯 ×N（剩余 M 炷）`. The 梁号 resets on the business date with 今日凝香. Vote buttons may sit at 38px to fund that row. Do not add a fifth region or a personal-growth section
