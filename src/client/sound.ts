 ...
 * 升梁 / 降梁 / 香火增长 each play a short tone. Volume is a 4-step cosmetic
 * preference (0=无, 1=小 33%, 2=中 66%, 3=大 100%) persisted in localStorage;
 * it scales the synthesized gain only — it never touches system volume.
 */
